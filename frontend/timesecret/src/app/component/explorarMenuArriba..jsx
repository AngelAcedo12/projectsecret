...
export default function ExplorarTop(){
    ...
    return (
        ...
        <div className=" hidden w-fit items-center  align-middle justify-center">
            ...
            <div className="px-2 hover:bg-slate-300 dark:hover:bg-slate-500 py-2 rounded-full cursor-pointer focus:bg-slate-300">
                    ...
                    36.015625 30.09375 34.34375 L 42.375 46.625 L 46.625 42.375 L 34.5 30.28125 C 36.679688 27.421875 38 23.878906 38 20 C 38 10.601563 30.398438 3 21 3 Z M 21 7 C 28.199219 7 34 12.800781 34 20 C
                     34 27.199219 28.199219 33 21 33 C 13.800781 33 8 27.199219 8 20 C 8 12.800781 13.800781 7 21 7 Z"/></svg>
