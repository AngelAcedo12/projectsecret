...
export default function MenuLater(){
    ...
    return (
        ...
        <ul className="h-full w-full items-center flex  flex-col">
            <li className=" w-full flex flex-row text-center items-center px-1 rounded-lg dark:hover:bg-slate-500 hover:bg-slate-300  gap-2  ">
               <Inicio></Inicio>
